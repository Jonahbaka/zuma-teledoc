...
export const MARKET_HOME_DATA = {
  ...
  NG: {
    ...
    stats: [
      { icon: Video, value: 'Online consultations', label: 'doctor visits from the same platform' },
      { icon: Search, value: 'Medicine search', label: 'compare pharmacy availability in minutes' },
      { icon: CreditCard, value: 'Naira checkout', label: 'transfer, card, and USSD support' },
      { icon: Truck, value: 'Tracked fulfillment', label: 'pickup and delivery status stays visible' },
    ],
    featureSection: {
    ...
    pricingSection: {
      title: 'Nigeria pricing stays local and easy to scan',
      subtitle: 'Commercial language remains in naira and supports the pharmacy network without leaking US subscription messaging into the page.',
      note: 'Patients still see medication and fulfillment pricing before checkout, while pharmacy partnerships follow the live Nigeria configuration.',
    },
    plans: [
      {
        eyebrow: 'Basic',
        title: '\u20A620,000',
        period: '/month',
        description: 'Entry plan for pharmacies joining the live Nigeria prescription network.',
        tone: 'emerald',
        featured: false,
        features: [
      ...
      },
      {
        ...
        title: '\u20A650,000',
        period: '/month',
        description: 'Broader operational support for growing pharmacies handling more consultation-driven demand.',
        tone: 'blue',
        featured: true,
        features: [
          'Everything in Basic',
      ...
      },
      {
        ...
        title: '\u20A6100,000',
        period: '/month',
        description: 'Advanced visibility for high-throughput pharmacies serving recurring digital care workflows.',
        tone: 'violet',
        featured: false,
        features: [
