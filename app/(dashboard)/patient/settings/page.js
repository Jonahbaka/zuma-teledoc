...
export default function PatientSettingsPage() {
  ...
  const handleNotificationSave = async () => {
    ...
    try {
      ...
      // This would require a backend endpoint for notification preferences
      toast({
        title: 'Success',
            ...
            <div className="space-y-4">
              ...
              <div className="flex items-center justify-between p-4 border border-slate-200 rounded-lg">
                <div>
                  ...
                  <p className="text-sm text-slate-500">Get notified about appointment changes</p>
                </div>
                <button
                ...
                >
                  <div className={`w-5 h-5 bg-white rounded-full shadow transform transition-transform ${
                    notifications.appointmentUpdates ? 'translate-x-5' : 'translate-x-1'
                  }`} />
                </button>
              </div>
            </div>
