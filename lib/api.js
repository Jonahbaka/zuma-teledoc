...
// In the browser, always use the Next.js API proxy (relative URL) so we don't depend on
// cross-origin CORS settings and don't accidentally hit production from localhost.
// On the server (rare for this client), fall back to an absolute API URL.
const API_URL =
