...
// User schemas
const userRoleSchema = z.enum(['patient', 'provider', 'pharmacy', 'admin']);
...
const registerSchema = z.object({
  ...
  phone: phoneSchema,
  // Global addressing (country-dependent UI; stored in existing user columns)
  country: z.string().max(2).optional(),
  addressLine1: z.string().max(255).optional(),
  addressLine2: z.string().max(255).optional(),
  city: z.string().max(100).optional(),
  region: z.string().max(100).optional(), // state/province/county
...
const loginSchema = z.object({
  ...
  role: z.enum(['patient', 'provider', 'pharmacy', 'admin', 'super_admin']).optional()
}).transform(data => ({
  ...data,
...
const searchUsersSchema = paginationSchema.extend({
  ...
  isTestAccount: z.coerce.boolean().optional(),
  mustChangePassword: z.coerce.boolean().optional(),
  market: z.enum(['US', 'NG', 'USA', 'Nigeria']).optional(),
  marketScope: z.enum(['US', 'NG']).optional(),
  country: z.enum(['US', 'NG', 'USA', 'Nigeria']).optional(),
