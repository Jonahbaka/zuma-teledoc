...
const PORTAL_ACCOUNTS = [
  ...
  {
    key: 'provider-tester-simon',
    role: 'provider',
    targetEmail: 'simonabigail16@gmail.com',
    legacyEmails: [],
    firstName: 'Simona',
    lastName: 'Abigail',
    accessLevel: 'gold_monthly',
    ...
    specialty: 'General Practice',
    credentials: 'MD',
    npiNumber: '2234567890',
    licenseNumber: 'MD-TEST-002',
    licenseState: 'California',
    bio: 'Test provider account for portal validation across provider workflows.',
  },
  {
    key: 'admin',
    role: 'admin',
