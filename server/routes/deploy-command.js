...
function buildDeployCommand() {
  return [
    ...
    "(sudo find /etc/nginx -name '*.conf' -exec grep -l '_next' {} \\; 2>/dev/null | xargs -r sudo sed -i -E 's|/home/ubuntu/zuma-teledoc|/home/ec2-user/zuma-teledoc|g; s|/home/[^ ;]*/[^ ;]*/(_next|\\\\.next)/static|/home/ec2-user/zuma-teledoc/.next/static|g' 2>/dev/null || true)",
